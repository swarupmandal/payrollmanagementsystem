...
public class ComponentPerUnitMasterSql {
	...
	public static final String insertComponentPerUnitQuery = "INSERT INTO pms_component_master_per_unit(component_id, component_name, component_type_id, company_id, unit_id, created_by, updatetd_by)VALUES (?, ?, ?, ?, ?,?, ?) "; 
