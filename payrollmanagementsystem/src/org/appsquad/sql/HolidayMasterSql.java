...
public class HolidayMasterSql {
	...
	public static final String saveGeneralHoliDayMasterData = "INSERT INTO pms_general_holiday_master(date, holiday_name, created_by, updated_by, leave_year_id, company_id, unit_id, month_Id) VALUES (?, ?, ?, ?, ?, ?, ?, ?) ";
