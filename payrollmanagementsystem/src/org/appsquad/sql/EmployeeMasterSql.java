...
public class EmployeeMasterSql {
	...
	public static final String updatePfEsiQuery = "UPDATE pms_employee_pf_esi_details SET pf_number = ?, uan_number = ?, esi = ?, updatetd_by=? WHERE employee_id=?";
	...
	public static final String empInactiveQuery = "UPDATE pms_employee_master SET is_delete='Y' WHERE employee_id = ? ";
